...
/*document.addEventListener("DOMContentLoaded", () => {
    ...
    addToCartBtn?.addEventListener("click", () => {
        ...
        renderCart(); // sidebar / cart render function
        updateCartCounts();
