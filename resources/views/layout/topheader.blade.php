<div class="header py-2 bodyBg">
   <div class="container">
      <div class="row">
         ...
         <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="col-auto d-lg-none">
               <a href="{{url('/')}}">
                  <img src="{{asset('/images/top-logo.png')}}" class="img-fluid" alt="logo" width="55px">
               </a>
            </div>
      ...
      <nav class="navbar navbar-expand-sm sticky-top navbar-light" style="margin-top: -7px; margin-bottom: -7px;">
          <div class="ribon d-flex justify-content-between align-items-center">
            <div class="clr"></div>
        ...
        <!-- topheader.blade.php বা master layout এ -->
<script>
    window.BASE_URL = "{{ url('https://dev.khut.shop/khut-bd-site/public') }}"; 
</script>
