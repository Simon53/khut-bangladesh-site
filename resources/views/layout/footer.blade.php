      <footer class="footer topGap-1">
         ...
         <div class="d-flex justify-content-center py-1 footer-title mt-4 mt-4Moblile">
            <img src="{{asset('/images/facebook.png')}}" class="img-fluid p-1" alt="..."> 
            <img src="{{asset('/images/istagram.png')}}" class="img-fluid p-1" alt="...">       
            <img src="{{asset('/images/youtube.png')}}" class="img-fluid p-1" alt="...">       
         </div>
