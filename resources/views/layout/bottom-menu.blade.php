    <div class="bottom-nav-mobile">
      ...
      <div class="slide-menu" id="slideMenu" style="overflow-y: scroll;">
       ...
       <ul>
         ...
         <div class="d-flex justify-content-center bd-highlight for-mobile-socail">
            <div class="p-2 bd-highlight joinUs justify-content-center">
               <h2 class="joinUs" >Join Us</h2>
               <img src="{{asset('/images/facebook.png')}}" class="img-fluid p-1 mobile-media-icon" alt="...">
               <img src="{{asset('/images/istagram.png')}}" class="img-fluid p-1 mobile-media-icon" alt="...">
               <img src="{{asset('/images/youtube.png')}}" class="img-fluid p-1 mobile-media-icon" alt="...">
            </div>
         </div>
      </div>
      <!-- Overlay -->
